(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/router'), require('rxjs'), require('rxjs/operators'), require('@angular/common'), require('@angular/common/http')) :
	typeof define === 'function' && define.amd ? define('angular-loading-page', ['exports', '@angular/core', '@angular/router', 'rxjs', 'rxjs/operators', '@angular/common', '@angular/common/http'], factory) :
	(factory((global['angular-loading-page'] = {}),global.ng.core,global.ng.router,global.rxjs,global.Rx.Observable.prototype,global.ng.common,global.ng.common.http));
}(this, (function (exports,core,router,rxjs,operators,common,http) { 'use strict';

var RouteInterceptorService =               (function () {
    function RouteInterceptorService(router$$1) {
        var _this = this;
        this.router = router$$1;
        this._isPendingRouteSubject = new rxjs.Subject();
        if (this.router) {
...
var HttpObservableService =               (function () {
    function HttpObservableService() {
        ...
        this._isPendingRequestsSubject = new rxjs.Subject();
    }
...
ChasingDotsComponent.propDecorators = {
    "colorOne": [{ type: core.Input },],
    "colorTwo": [{ type: core.Input },],
};
...
exports.LoadingPageModule = LoadingPageModule;
exports.LoadingPageDirective = LoadingPageDirective;
exports.HttpInterceptorService = HttpInterceptorService;
exports.HttpInterceptorServiceFactory = HttpInterceptorServiceFactory;
exports.HttpObservableService = HttpObservableService;
exports.RouteInterceptorService = RouteInterceptorService;
exports.ChasingDotsModule = ChasingDotsModule;
...
exports.DoubleBounceModule = DoubleBounceModule;
exports.DoubleBounceComponent = DoubleBounceComponent;
exports.FadingCircleModule = FadingCircleModule;
exports.FadingCircleComponent = FadingCircleComponent;
exports.FoldingCubeModule = FoldingCubeModule;
exports.FoldingCubeComponent = FoldingCubeComponent;
exports.MaterialBarModule = MaterialBarModule;
exports.MaterialbarComponent = MaterialbarComponent;
exports.PulseModule = PulseModule;
exports.PulseComponent = PulseComponent;
exports.SlidingBarModule = SlidingBarModule;
exports.SlidingBarComponent = SlidingBarComponent;
exports.ThreeBounceModule = ThreeBounceModule;
exports.ThreeBounceComponent = ThreeBounceComponent;
exports.WanderingCubesModule = WanderingCubesModule;
...
//# sourceMappingURL=angular-loading-page.umd.js.map
